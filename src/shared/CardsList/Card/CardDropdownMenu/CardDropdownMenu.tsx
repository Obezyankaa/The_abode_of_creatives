...
export function CardDropdownMenu({open,setOpen}:IDropsownProps) {
  return (
    <div className={styles.cmd__block}>
      <ul className={styles.cmd__list}>
        <li className={styles.cmd__item}> 
          ...
          <svg className={styles.cmd__svg} width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
