...
export function CardDropdownMenu({ open, setOpen, postId, rect }: IDropsownProps) {
  
  const dropNode = document.querySelector("#dropdowmenu_root");
  ...
  return ReactDOM.createPortal(
    <div className={styles.cmd__block} style={{
      ...
      <ul className={styles.cmd__list}>
        ...
        <li className={styles.cmd__item}>
          <div
            className={`${styles.cmd__block_text} ${styles.cmd__block_text_complain}`}
          >
            <svg
              className={styles.cmd__svg}
              width="16"
        ...
        <li
          ...
          className={`${styles.cmd__item} ${styles.cmd__item__close}`}
        >
