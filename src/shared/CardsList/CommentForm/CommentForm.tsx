...
export function CommentForm({ id }: ICommentForm) {
  console.log(id);
    ...
    useEffect(() => {
      ...
      axios
        ...
        .then((resp) => {
          ...
          setCommentAPI(commentsData);
        })
        .catch(console.log);
      }, [id]);
      
  console.log("commentsData--->", commentAPI);
  ...
  return (
    <>
      <form className={styles.form} onSubmit={handleSubmit}>
        ...
        />
        <div className={styles.сontainerButton}>
      ...
      <div>{commentAPI ? commentAPI : <h3>нет коментов =Ю</h3>}</div>
    </>
  );
}
